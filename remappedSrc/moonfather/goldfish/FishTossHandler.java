...
public class FishTossHandler
{
	...
	{
		if (entityItem.method_48926() instanceof ServerWorld)
		{
			...
			if (entityItem.isSubmergedInWater())
			{
				...
				while (entityItem.method_48926().getFluidState(pos).isIn(FluidTags.WATER))
				{
					pos.set(pos.getX(), pos.getY() + 1, pos.getZ());
				}
				yPos = pos.getY() - 0.3d;
			}
			ServerWorld world = (ServerWorld) entityItem.method_48926();
			for (int i = 1; i <= 16; i++)
			{
